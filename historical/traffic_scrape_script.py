...
api_key = ''
url = f"https://api.tomtom.com/traffic/services/4/flowSegmentData/relative0/10/json?point=43.63881659862974%2C-79.39156109746042&unit=KMPH&thickness=1&openLr=false&key={api_key}"
...
conn = sqlite3.connect('tomTom_data.db')
cursor = conn.cursor()
