...
api_key = ''
url = f"https://api.tomtom.com/traffic/services/4/flowSegmentData/relative0/10/json?point=43.64399%2C-79.38859&unit=KMPH&thickness=1&openLr=false&key={api_key}"
...
conn = sqlite3.connect('tomTom_data_air_monitor.db')
cursor = conn.cursor()
